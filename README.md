...
- **해외 주식 티커 지원**: 해외 주식도 티커로 추가 가능 (Yahoo 차단 시 Stooq로 폴백)
...
- **Yahoo Finance API**: 해외 주식 데이터 소스
- **Stooq API**: 해외 주식 폴백 데이터 소스
...
- 이 확장 프로그램은 한국 주식은 Naver Finance, 해외 주식은 Yahoo Finance의 데이터를 기반으로 합니다
- Yahoo가 차단되는 환경에서는 일부 해외 주식이 Stooq로 폴백될 수 있습니다
- 실시간 시세가 아닐 수 있습니다
